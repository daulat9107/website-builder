    ...
    <div class="panel panel-default">
      ...
      >
        <form action="#" @submit.prevent="store">
          <div class="flex gap-4" v-for="form_data_chunk in response.formData">
            <div
              class="flex-1 mb-4"
              v-for="column in form_data_chunk"
              :class="{ 'text-rose-600': creating.errors[column] }"
            >
      ...
      <div class="relative">
        ...
        <div class="flex justify-between my-10">
          <div class="flex-1">
            <label :for="`filter_${name}`">Quick search current results</label>
            <input
              type="text"
              class="px-3 py-2 max-w-full dark:bg-slate-800 focus:ring focus:outline-none border-gray-700 rounded w-full dark:placeholder-gray-400"
              :id="`filter_${name}`"
      ...
      <div class="panel-body">
        ...
        >
          ...
          >
            ...
            >
              <tr>
                <th scope="col" class="px-6 py-3" v-if="canSelectItems && response.allow.deletion">
                  <input
                    type="checkbox"
                ...
                <th scope="col" class="px-6 py-3" v-for="column in response.displayable">
                  <span class="cursor-pointer" @click="sortBy(column)">{{
                ...
                <th scope="col" class="px-6 py-3" v-if="response.allow.updation">&nbsp;</th>
                <th scope="col" class="px-6 py-3" v-if="response.allow.deletion">&nbsp;</th>
              </tr>
            </thead>
            <tbody>
              <tr
              ...
              >
                <td class="px-6 py-4" v-if="canSelectItems && response.allow.deletion">
                  <input
                    type="checkbox"
                    class="dark:bg-slate-800"
                    :value="record.id"
                ...
                <td class="px-6 py-4" v-for="(columnValue, column) in record">
                  <template v-if="editing.id === record.id && isUpdatable(column) ">
                    <div :class="{ 'has-error': editing.errors[column] }">
                      <input
                        type="text"
                        class="px-3 py-2 dark:bg-slate-800 focus:ring focus:outline-none border-gray-700 rounded dark:placeholder-gray-400"
                ...
                <td class="px-6 py-4" v-if="response.allow.updation">
