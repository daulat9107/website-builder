        ...
        <level>
            <level type="justify-start">
                ...
                <div class="text-center space-y-1 md:text-left md:mr-6">
                    <h4 class="text-xl text-text-950 dark:text-text">
                        ${{ amount }}
                    </h4>
                    <p class="text-text-500 dark:text-text-400">
                        <b>{{ date }}</b> via {{ business }}
                    </p>
                </div>
            </level>
            <div
                class="text-center md:text-right space-y-1 text-text-950 dark:text-text"
            >
                <p>{{ name }}</p>
                <div>
